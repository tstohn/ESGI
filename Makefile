...
demultiplexing:
	g++ $(LDFLAGS) $(CXXFLAGS)-c src/lib/BarcodeMapping.cpp -I ./include/ -I ./src/lib -I src/tools/Demultiplexing --std=c++17 $(CXXFLAGS)
	g++ $(LDFLAGS) $(CXXFLAGS)-c src/tools/Demultiplexing/DemultiplexedLinesWriter.cpp -I ./include/ -I ./src/lib -I src/tools/Demultiplexing --std=c++17 $(CXXFLAGS)
	g++ $(LDFLAGS) $(CXXFLAGS)-c src/tools/Demultiplexing/main.cpp -I ./include/ -I ./src/lib -I src/tools/Demultiplexing --std=c++17 $(CXXFLAGS)
	g++ $(LDFLAGS) main.o DemultiplexedLinesWriter.o BarcodeMapping.o -o ./bin/demultiplexing -lpthread -lz -lboost_iostreams -lboost_program_options
