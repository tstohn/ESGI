...
processing:
	g++ src/Tools/BarcodeProcessing/BarcodeProcessing.cpp -o bin/processing -pthread -lz -lboost_program_options -lboost_iostreams -I ./Tools/ -I ./src/lib -I ./src/Tools/AbFastqParser --std=c++11
